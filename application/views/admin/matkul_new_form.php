        ...
        <div class="container-fluid mt-n1">
            ...
            <form action="" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="kode_mk" id="kode_mk" placeholder="Masukkan Kode Mata Kuliah" required title="Wajib isi kode mata kuliah" />
                </div>

                <div class="form-group">
                    <label for="nama_mk">Nama Mata Kuliah</label>
                    <input type="text" class="form-control" name="nama_mk" id="nama_mk" placeholder="Masukkan Nama Mata Kuliah" required title="Wajib nama mata kuliah" />
                </div>

                <div class="form-group">
                    <label for="sks_mk">SKS</label>
                    <select name="sks_mk" class="form-control" id="" required>
                        <option value="" disabled selected value>- Pilih SKS -</option>
